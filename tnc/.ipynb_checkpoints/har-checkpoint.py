...
BASE_DIR_HAR = 'data/athena/HAR'

train_uwave = torch.load(f'{BASE_DIR_HAR}/train.pt')
test_uwave = torch.load(f'{BASE_DIR_HAR}/test.pt')
...
with open(f'{BASE_DIR_HAR}/x_train.pkl', 'wb') as f:
    pickle.dump(trainX, f)
with open(f'{BASE_DIR_HAR}/x_test.pkl', 'wb') as f:
    pickle.dump(testX, f)
with open(f'{BASE_DIR_HAR}/state_train.pkl', 'wb') as f:
    pickle.dump(trainy, f)
with open(f'{BASE_DIR_HAR}/state_test.pkl', 'wb') as f:
    pickle.dump(testy, f)
